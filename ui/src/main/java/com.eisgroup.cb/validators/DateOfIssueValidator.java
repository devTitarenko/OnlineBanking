...
@Component
@Scope("request")
public class DateOfIssueValidator implements Validator {
    ...
    public void validate(FacesContext facesContext, UIComponent uiComponent, Object value) throws ValidatorException {
        ...
        if (!dateOfBirth.isAfter(today.minusYears(OLD).minusDays(2)) || !dateOfBirth.isBefore(today.plusDays(1))) {
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "",
                    resourceBundle.getString("Error.dateIssue.outside")));
        }
    }
}